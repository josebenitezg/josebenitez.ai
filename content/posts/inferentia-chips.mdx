...
date: "2023-11-13"
description: "Lessons from running computer-vision inference with AWS Inferentia, PyTorch, and AWS Neuron."
...
Original blogpost: [Intuitivo achieves higher throughput while saving on AI/ML costs using AWS Inferentia and PyTorch](https://aws.amazon.com/blogs/machine-learning/intuitivo-achieves-higher-throughput-while-saving-on-ai-ml-costs-using-aws-inferentia-and-pytorch/)
...
![AWS Architecture Diagram](/blog/diagram_aws-E0NT.png)
...
![AWS Architecture Diagram](/blog/fps_achived-E5ND.png)
